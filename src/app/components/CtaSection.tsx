  ...
  return (
    <section className="py-24 px-8 relative overflow-hidden" style={{ backgroundColor: bg }}>
      ...
      <div className="max-w-[1000px] mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        >
          Ready to Transform Your <span className="italic text-[#8C6A4A]">Environment?</span>
        </motion.h2>
        ...
        >
          Schedule a personalized consultation with our elite interior architecture team to discuss your vision and requirements.
        </motion.p>
